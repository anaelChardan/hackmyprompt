...
export declare function renderLlmRubricPrompt(rubric: string, llmOutput: string, grading?: GradingConfig, vars?: Record<string, string | object>): Promise<string>;
export declare function matchesLlmRubric(rubric: string, llmOutput: string, grading?: GradingConfig, vars?: Record<string, string | object>, assertion?: Assertion | null): Promise<GradingResult>;
