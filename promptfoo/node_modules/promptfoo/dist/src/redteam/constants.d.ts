...
export declare const REDTEAM_MODEL = "openai:chat:gpt-4o";
...
export declare const ADDITIONAL_PLUGINS: readonly ["ascii-smuggling", "beavertails", "bfla", "bola", "competitors", "cross-session-leak", "cyberseceval", "debug-access", "divergent-repetition", "tool-discovery", "harmbench", "imitation", "indirect-prompt-injection", "overreliance", "prompt-extraction", "pliny", "rag-document-exfiltration", "rag-poisoning", "rbac", "reasoning-dos", "religion", "shell-injection", "sql-injection", "ssrf", "system-prompt-override"];
...
export declare const STRATEGY_EXEMPT_PLUGINS: readonly ["pliny", "system-prompt-override"];
export type StrategyExemptPlugin = (typeof STRATEGY_EXEMPT_PLUGINS)[number];
export type Plugin = AdditionalPlugin | BasePlugin | Collection | ConfigRequiredPlugin | HarmPlugin | PIIPlugin;
...
export declare const ALIASED_PLUGINS: readonly ["mitre:atlas", "nist:ai", "nist:ai:measure", "owasp:api", "owasp:llm", "toxicity", "bias", "misinformation", "illegal-activity", "personal-safety", ...string[]];
export declare const ALIASED_PLUGIN_MAPPINGS: Record<string, Record<string, {
    plugins: string[];
    strategies: string[];
}>>;
export declare const FRAMEWORK_COMPLIANCE_IDS: readonly ["mitre:atlas", "nist:ai:measure", "owasp:api", "owasp:llm"];
...
export declare const ADDITIONAL_STRATEGIES: readonly ["audio", "base64", "best-of-n", "citation", "crescendo", "gcg", "goat", "hex", "image", "jailbreak:likert", "jailbreak:tree", "leetspeak", "math-prompt", "multilingual", "pandamonium", "prompt-injection", "retry", "rot13"];
export type AdditionalStrategy = (typeof ADDITIONAL_STRATEGIES)[number];
export declare const ALL_STRATEGIES: ("default" | "basic" | "jailbreak" | "jailbreak:composite" | "audio" | "base64" | "best-of-n" | "citation" | "crescendo" | "gcg" | "goat" | "hex" | "image" | "jailbreak:likert" | "jailbreak:tree" | "leetspeak" | "math-prompt" | "multilingual" | "pandamonium" | "prompt-injection" | "retry" | "rot13")[];
...
export declare const categoryDescriptions: {
    ...
    'Content Safety & Moderation': string;
    'Compliance & Legal': string;
    'Output Quality & Trust': string;
};
