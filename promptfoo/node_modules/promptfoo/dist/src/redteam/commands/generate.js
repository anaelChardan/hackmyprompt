...
async function doGenerateRedteam(options) {
    ...
    if (configPath) {
        ...
        logger_1.default.info(chalk_1.default.red(`\nCan't generate without configuration - run ${chalk_1.default.yellow.bold((0, util_2.isRunningUnderNpx)() ? 'npx promptfoo redteam init' : 'promptfoo redteam init')} first`));
        return null;
    }
    ...
    if (options.output && options.output.endsWith('.burp')) {
        ...
        if (!options.inRedteamRun) {
            const commandPrefix = (0, util_2.isRunningUnderNpx)() ? 'npx promptfoo' : 'promptfoo';
