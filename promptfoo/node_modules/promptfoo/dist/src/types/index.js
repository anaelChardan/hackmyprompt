...
const shared_1 = require("../validators/shared");
...
exports.TestCaseSchema = zod_1.z.object({
    ...
    assertScoringFunction: zod_1.z
        ...
        zod_1.z
            .string()
            .regex(new RegExp(`^file://.*\\.(${file_1.JAVASCRIPT_EXTENSIONS.join('|')}|py)(?::[\\w.]+)?$`)),
        zod_1.z.custom(),
    ])
        .optional(),
...
exports.TestSuiteSchema = zod_1.z.object({
    ...
    // Nunjucks filters
    nunjucksFilters: shared_1.NunjucksFilterMapSchema.optional(),
    // Envar overrides
    ...
    extensions: zod_1.z
        ...
        .refine((value) => {
        const parts = value.split(':');
        return ((parts[1].endsWith('.py') || (0, file_1.isJavascriptFile)(parts[1])) &&
