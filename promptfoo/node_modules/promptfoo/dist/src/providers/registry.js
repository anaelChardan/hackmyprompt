...
const googleMultimodalLive_1 = require("./googleMultimodalLive");
...
exports.providerMap = [
    ...
    {
        test: (providerPath) => providerPath.startsWith('exec:'),
        create: async (providerPath, providerOptions, context) => {
            // Load script module
    ...
    {
        test: (providerPath) => providerPath.startsWith('golang:') ||
        ...
        create: async (providerPath, providerOptions, context) => {
            ...
            return new golangCompletion_1.GolangProvider(scriptPath, providerOptions);
        },
    },
    {
    ...
    },
    {
        ...
        create: async (providerPath, providerOptions, context) => {
            ...
            const modelName = splits.slice(2).join(':');
            if (modelType === 'chat') {
                return new chat_2.OpenAiChatCompletionProvider(modelName || 'gpt-4o-mini', providerOptions);
            }
            if (modelType === 'embedding' || modelType === 'embeddings') {
            ...
            if (modelType === 'responses') {
                return new responses_1.OpenAiResponsesProvider(modelName || 'gpt-4o', providerOptions);
            }
        ...
        create: async (providerPath, providerOptions, context) => {
            ...
            if (splits.length >= 3) {
                ...
                if (serviceType === 'live') {
                    ...
                    return new googleMultimodalLive_1.GoogleMMLiveProvider(modelName, providerOptions);
                }
            }
            // Default to regular Google API
            const modelName = splits[1];
            return new google_1.GoogleChatProvider(modelName, providerOptions);
        },
    },
    {
    ...
    {
        test: (providerPath) => (0, file_1.isJavascriptFile)(providerPath),
        create: async (providerPath, providerOptions, context) => {
    ...
    {
        test: (providerPath) => providerPath.startsWith('python:') ||
            (providerPath.startsWith('file://') &&
