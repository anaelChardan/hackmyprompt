...
async function getDefaultProviders(env) {
    ...
    if (preferAzure) {
        ...
        providers = {
            datasetGenerationProvider: defaults_2.DefaultGradingProvider,
