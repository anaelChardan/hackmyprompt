...
class VertexChatProvider extends VertexGenericProvider {
    ...
    async callGeminiApi(prompt, context) {
        ...
        const body = {
            ...
            ...(this.config.tools
                ? { tools: (0, util_2.maybeLoadFromExternalFile)((0, util_1.renderVarsInObject)(this.config.tools, context?.vars)) }
                : {}),
