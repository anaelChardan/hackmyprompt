    ...
    getOpenAiBody(prompt, context, callApiOptions) {
        ...
        if (config.response_format) {
            if (config.response_format.type === 'json_object') {
                ...
                const schema = (0, util_2.maybeLoadFromExternalFile)((0, util_1.renderVarsInObject)(config.response_format.schema || config.response_format.json_schema?.schema, context?.vars));
        ...
        try {
            ...
            if (isRefusal) {
                return {
                    ...
                    isRefusal: true,
                    cached,
                    cost: (0, util_3.calculateOpenAICost)(this.modelName, config, data.usage?.input_tokens, data.usage?.output_tokens, 0, 0),
                    raw: data,
                };
            }
            ...
            const tokenUsage = (0, util_4.getTokenUsage)(data, cached);
            return {
                output: result,
                tokenUsage,
                cached,
