...
exports.DefaultGradingProvider = new chat_1.OpenAiChatCompletionProvider('gpt-4o-2024-11-20');
exports.DefaultGradingJsonProvider = new chat_1.OpenAiChatCompletionProvider('gpt-4o-2024-11-20', {
    config: {
        response_format: { type: 'json_object' },
    },
});
exports.DefaultSuggestionsProvider = new chat_1.OpenAiChatCompletionProvider('gpt-4o-2024-05-13');
