...
class OpenAiAssistantProvider extends _1.OpenAiGenericProvider {
    ...
    async callApi(prompt, context, callApiOptions) {
        ...
        const body = {
            ...
            tools: (0, util_2.maybeLoadFromExternalFile)((0, util_1.renderVarsInObject)(this.assistantConfig.tools, context?.vars)) ||
                undefined,
        ...
        try {
            ...
            return (0, util_3.failApiCall)(err);
        }
        ...
        return {
            ...
            tokenUsage: (0, util_3.getTokenUsage)(run, false),
        };
    }
}
