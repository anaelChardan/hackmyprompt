...
function validateFunctionCall(functionCall, functions, vars) {
    // Parse function call and validate it against schema
    const interpolatedFunctions = (0, util_1.maybeLoadFromExternalFile)((0, util_1.renderVarsInObject)(functions, vars));
...
function formatOpenAiError(data) {
    ...
    errorMessage += '\n\n' + (0, json_1.safeJsonStringify)(data, true /* prettyPrint */);
    return errorMessage;
}
