    ...
    async callApi(prompt, context, callApiOptions) {
        ...
        try {
            ...
            if (this.providerName === 'openai') {
                ...
                const parentClass = new google_2.GoogleChatProvider(this.modelName, this.providerOptions);
                const apiKey = parentClass.getApiKey();
                if (!apiKey) {
        ...
        try {
            ...
            if (this.providerName === 'openai') {
                cost = (0, util_3.calculateOpenAICost)(this.modelName, costConfig, response.response.usage?.promptTokens, response.response.usage?.completionTokens);
            }
            else if (this.providerName === 'azureopenai') {
                cost = (0, util_2.calculateAzureCost)(this.modelName, {}, response.response.usage?.promptTokens, response.response.usage?.completionTokens);
            }
            else if (this.providerName === 'anthropic') {
                cost = (0, util_1.calculateAnthropicCost)(this.modelName, costConfig, response.response.usage?.promptTokens, response.response.usage?.completionTokens);
            }
