...
class AzureChatCompletionProvider extends generic_1.AzureGenericProvider {
    ...
    getOpenAiBody(prompt, context, callApiOptions) {
        ...
        const responseFormat = config.response_format
            ? {
                response_format: (0, util_1.maybeLoadFromExternalFile)((0, util_1.renderVarsInObject)(config.response_format, context?.vars)),
            }
            : {};
        ...
        const body = {
            ...
            ...(config.functions
                ? {
                    functions: (0, util_1.maybeLoadFromExternalFile)((0, util_1.renderVarsInObject)(config.functions, context?.vars)),
                }
                : {}),
            ...(config.function_call ? { function_call: config.function_call } : {}),
            ...(config.tools
                ? {
                    tools: (0, util_1.maybeLoadFromExternalFile)((0, util_1.renderVarsInObject)(config.tools, context?.vars)),
                }
                : {}),
