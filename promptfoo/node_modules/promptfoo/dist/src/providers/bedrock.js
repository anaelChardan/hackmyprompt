...
exports.AwsBedrockEmbeddingProvider = exports.AwsBedrockCompletionProvider = exports.AwsBedrockGenericProvider = exports.AWS_BEDROCK_MODELS = exports.BEDROCK_MODEL = exports.getLlamaModelHandler = exports.formatPromptLlama3Instruct = exports.formatPromptLlama2Chat = exports.LlamaVersion = void 0;
...
exports.BEDROCK_MODEL = {
    ...
    CLAUDE_MESSAGES: {
        params: (config, prompt, stop, modelName) => {
            ...
            addConfigParam(params, 'anthropic_version', config?.anthropic_version, undefined, 'bedrock-2023-05-31');
            addConfigParam(params, 'tools', (0, util_1.maybeLoadFromExternalFile)(config?.tools), undefined, undefined);
        ...
        tokenUsage: (responseJson, promptText) => {
            if (responseJson?.meta?.billed_units) {
                return {
                    ...
                    total: responseJson.meta.billed_units.input_tokens +
    ...
    COHERE_COMMAND_R: {
        params: (config, prompt, stop, modelName) => {
            ...
            addConfigParam(params, 'tools', (0, util_1.maybeLoadFromExternalFile)(config?.tools));
        ...
        tokenUsage: (responseJson, promptText) => {
            ...
            if (responseJson?.prompt_tokens !== undefined &&
                ...
                return {
                    ...
                    total: responseJson.total_tokens ||
    ...
    async callApi(prompt) {
        ...
        try {
            ...
            if (model.tokenUsage) {
                ...
                logger_1.default.debug(`Extracting token usage from API response for ${this.modelName}`);
