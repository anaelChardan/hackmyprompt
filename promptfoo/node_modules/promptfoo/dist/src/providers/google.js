...
exports.GoogleChatProvider = void 0;
const cache_1 = require("../cache");
const envars_1 = require("../envars");
const logger_1 = __importDefault(require("../logger"));
const util_1 = require("../util");
const templates_1 = require("../util/templates");
const googleShared_1 = require("./googleShared");
const shared_1 = require("./shared");
const vertexUtil_1 = require("./vertexUtil");
const DEFAULT_API_HOST = 'generativelanguage.googleapis.com';
class GoogleGenericProvider {
...
class GoogleChatProvider extends GoogleGenericProvider {
    constructor(modelName, options = {}) {
        if (!googleShared_1.CHAT_MODELS.includes(modelName)) {
    ...
    async callGemini(prompt, context) {
        const { contents, systemInstruction } = (0, vertexUtil_1.maybeCoerceToGeminiFormat)((0, shared_1.parseChatPrompt)(prompt, [{ content: prompt }]));
        ...
        if (this.config.responseSchema) {
            ...
            const schema = (0, util_1.maybeLoadFromExternalFile)((0, util_1.renderVarsInObject)(this.config.responseSchema, context?.vars));
...
exports.GoogleChatProvider = GoogleChatProvider;
