...
async function loadRubricPrompt(rubricPrompt, defaultPrompt) {
    ...
    if (typeof rubricPrompt === 'string' &&
        ...
        (0, file_1.isJavascriptFile)(rubricPrompt)) {
...
async function renderLlmRubricPrompt(rubric, llmOutput, grading, vars) {
...
async function matchesLlmRubric(rubric, llmOutput, grading, vars, assertion) {
    if (!grading) {
    ...
    (0, invariant_1.default)(typeof resp.output === 'string', 'llm-rubric produced malformed response');
    try {
