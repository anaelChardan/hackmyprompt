...
async function renderPrompt(prompt, vars, nunjucksFilters, provider) {
    ...
    for (const [varName, value] of Object.entries(vars)) {
        if (typeof value === 'string' && value.startsWith('file://')) {
            ...
            if ((0, file_1.isJavascriptFile)(filePath)) {
            ...
            else if (((0, file_1.isImageFile)(filePath) || (0, file_1.isVideoFile)(filePath) || (0, file_1.isAudioFile)(filePath)) &&
                !(0, envars_1.getEnvBool)('PROMPTFOO_DISABLE_MULTIMEDIA_AS_BASE64')) {
                const fileType = (0, file_1.isImageFile)(filePath)
                    ? 'image'
                    : (0, file_1.isVideoFile)(filePath)
                        ? 'video'
                        : 'audio';
                telemetry_1.default.recordOnce('feature_used', {
    ...
    try {
        ...
        return (0, util_1.renderVarsInObject)(nunjucks.renderString(basePrompt, vars), vars);
    }
}
/**
