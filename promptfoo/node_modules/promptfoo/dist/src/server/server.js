...
function createApp() {
    ...
    app.get('/api/results', async (req, res) => {
        ...
        const previousResults = await (0, database_1.listPreviousResults)(undefined /* limit */, undefined /* offset */, datasetId);
        res.json({
...
async function startServer(port = constants_1.DEFAULT_PORT, browserBehavior = server_1.BrowserBehavior.ASK, filterDescription) {
    const app = createApp();
