...
exports.logger = Object.assign({}, exports.winstonLogger, {
    error: (message) => {
        ...
        return exports.winstonLogger.error({ message, location });
    },
    warn: (message) => {
        const location = isDebugEnabled() ? getCallerLocation() : '';
        return exports.winstonLogger.warn({ message, location });
    },
    info: (message) => {
        const location = isDebugEnabled() ? getCallerLocation() : '';
        return exports.winstonLogger.info({ message, location });
    },
    debug: (message) => {
        initializeSourceMapSupport();
        const location = getCallerLocation();
        return exports.winstonLogger.debug({ message, location });
    },
