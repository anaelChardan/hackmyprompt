...
const handleIsValidOpenAiFunctionCall = ({ assertion, output, provider, test, }) => {
    ...
    try {
        (0, util_1.validateFunctionCall)(functionOutput, provider.config.functions, test.vars);
        return {
            pass: true,
            score: 1,
...
const handleIsValidOpenAiToolsCall = ({ assertion, output, provider, test, }) => {
    ...
    if (tools) {
        tools = (0, util_2.maybeLoadFromExternalFile)((0, util_2.renderVarsInObject)(tools, test.vars));
    }
