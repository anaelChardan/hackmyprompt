...
test, delay, nunjucksFilters: filters, evaluateOptions, testIdx, promptIdx, conversations, //
registers, isRedteam, allTests, concurrency, }) {
        ...
        const processEvalStep = async (evalStep, index) => {
            ...
            for (const row of rows) {
                ...
                if (options.progressCallback) {
                    options.progressCallback(this.evalRecord.resultsCount, runEvalOptions.length, index, evalStep, metrics);
                }
            }
        };
