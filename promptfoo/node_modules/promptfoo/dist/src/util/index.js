...
async function writeOutput(outputPath, evalRecord, shareableUrl) {
    ...
    if (outputExtension === 'csv') {
        // Write headers first
        const headers = (0, exportToFile_1.getHeaderForTable)(evalRecord);
        const headerCsv = (0, sync_2.stringify)([
        ...
        for await (const batchResults of evalRecord.fetchResultsBatched()) {
            ...
            const batchCsv = (0, sync_2.stringify)(Object.values(tableRows).map((results) => {
...
function parsePathOrGlob(basePath, promptPath) {
    ...
    if (filename.includes(':')) {
        ...
        if (splits[0] &&
            ((0, file_1.isJavascriptFile)(splits[0]) || splits[0].endsWith('.py') || splits[0].endsWith('.go'))) {
...
function maybeLoadFromExternalFile(filePath) {
    ...
    const renderedFilePath = (0, templates_1.getNunjucksEngine)().renderString(filePath, {});
