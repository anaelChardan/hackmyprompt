...
async function readConfig(configPath) {
    ...
    else if ((0, file_1.isJavascriptFile)(configPath)) {
...
async function resolveConfigs(cmdObj, _defaultConfig) {
    let fileConfig = {};
    ...
    if (fileConfig.scenarios) {
        fileConfig.scenarios = (await (0, util_1.maybeLoadFromExternalFile)(fileConfig.scenarios));
    }
