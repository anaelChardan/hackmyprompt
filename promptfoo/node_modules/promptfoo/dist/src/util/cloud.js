...
exports.cloudCanBuildFormattedConfig = cloudCanBuildFormattedConfig;
...
async function getProviderFromCloud(id) {
    ...
    try {
        ...
        logger_1.default.info(`Provider fetched from cloud: ${id}`);
...
async function getConfigFromCloud(id) {
    ...
    try {
        ...
        if (canBuildFormattedConfig) {
            ...
            logger_1.default.info(`Config fetched from cloud: ${id}`);
            logger_1.default.debug(`Config from cloud: ${JSON.stringify(body, null, 2)}`);
            return (0, sharedFrontend_1.getUnifiedConfig)(body.config);
        }
    }
    catch (e) {
