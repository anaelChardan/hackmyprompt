...
type IngestionReturnType = paths["/api/public/ingestion"]["post"]["responses"][207]["content"]["application/json"];
...
type EventBody = CreateLangfuseTraceBody | CreateLangfuseEventBody | CreateLangfuseSpanBody | CreateLangfuseGenerationBody | CreateLangfuseScoreBody | UpdateLangfuseSpanBody | UpdateLangfuseGenerationBody;
type Usage = FixTypes<components["schemas"]["IngestionUsage"]>;
type UsageDetails = FixTypes<components["schemas"]["UsageDetails"]>;
...
type GetLangfuseTracesQuery = FixTypes<paths["/api/public/traces"]["get"]["parameters"]["query"]>;
type GetLangfuseTracesResponse = FixTypes<paths["/api/public/traces"]["get"]["responses"]["200"]["content"]["application/json"]>;
type GetLangfuseTraceResponse = FixTypes<paths["/api/public/traces/{traceId}"]["get"]["responses"]["200"]["content"]["application/json"]>;
type GetLangfuseObservationsQuery = FixTypes<paths["/api/public/observations"]["get"]["parameters"]["query"]>;
type GetLangfuseObservationsResponse = FixTypes<paths["/api/public/observations"]["get"]["responses"]["200"]["content"]["application/json"]>;
type GetLangfuseObservationResponse = FixTypes<paths["/api/public/observations/{observationId}"]["get"]["responses"]["200"]["content"]["application/json"]>;
type GetLangfuseSessionsQuery = FixTypes<paths["/api/public/sessions"]["get"]["parameters"]["query"]>;
type GetLangfuseSessionsResponse = FixTypes<paths["/api/public/sessions"]["get"]["responses"]["200"]["content"]["application/json"]>;
type GetLangfuseDatasetParams = FixTypes<paths["/api/public/v2/datasets/{datasetName}"]["get"]["parameters"]["path"]>;
type GetLangfuseDatasetResponse = FixTypes<paths["/api/public/v2/datasets/{datasetName}"]["get"]["responses"]["200"]["content"]["application/json"]>;
type GetLangfuseDatasetItemsQuery = paths["/api/public/dataset-items"]["get"]["parameters"]["query"];
type GetLangfuseDatasetItemsResponse = FixTypes<paths["/api/public/dataset-items"]["get"]["responses"]["200"]["content"]["application/json"]>;
...
type CreateLangfuseDatasetBody = paths["/api/public/v2/datasets"]["post"]["requestBody"]["content"]["application/json"];
type CreateLangfuseDatasetResponse = FixTypes<paths["/api/public/v2/datasets"]["post"]["responses"]["200"]["content"]["application/json"]>;
...
type GetLangfuseDatasetRunsQuery = paths["/api/public/datasets/{datasetName}/runs"]["get"]["parameters"]["query"];
type GetLangfuseDatasetRunsPath = paths["/api/public/datasets/{datasetName}/runs"]["get"]["parameters"]["path"];
type GetLangfuseDatasetRunsResponse = FixTypes<paths["/api/public/datasets/{datasetName}/runs"]["get"]["responses"]["200"]["content"]["application/json"]>;
type CreateLangfusePromptBody = FixTypes<paths["/api/public/v2/prompts"]["post"]["requestBody"]["content"]["application/json"]>;
type UpdatePromptBody = FixTypes<paths["/api/public/v2/prompts/{name}/versions/{version}"]["patch"]["requestBody"]["content"]["application/json"]>;
type CreateLangfusePromptResponse = paths["/api/public/v2/prompts"]["post"]["responses"]["200"]["content"]["application/json"];
type GetLangfusePromptSuccessData = paths["/api/public/v2/prompts/{promptName}"]["get"]["responses"]["200"]["content"]["application/json"];
...
type GetMediaUploadUrlRequest = FixTypes<components["schemas"]["GetMediaUploadUrlRequest"]>;
type GetMediaUploadUrlResponse = FixTypes<components["schemas"]["GetMediaUploadUrlResponse"]>;
type MediaContentType = components["schemas"]["MediaContentType"];
type PatchMediaBody = FixTypes<components["schemas"]["PatchMediaBody"]>;
type GetMediaResponse = FixTypes<components["schemas"]["GetMediaResponse"]>;
...
type FixTypes<T> = T extends undefined ? undefined : Omit<{
    [P in keyof T]: P extends "startTime" | "endTime" | "timestamp" | "completionStartTime" | "createdAt" | "updatedAt" | "fromTimestamp" | "toTimestamp" | "fromStartTime" | "toStartTime" ? // Dates instead of strings
...
type DatasetItemData = GetLangfuseDatasetItemsResponse["data"][number];
type LinkDatasetItem = (obj: LangfuseObjectClient, runName: string, runArgs?: {
    description?: string;
    metadata?: any;
}) => Promise<{
    id: string;
}>;
type DatasetItem = DatasetItemData & {
    link: LinkDatasetItem;
};
type MaskFunction = (params: {
    data: any;
}) => any;
type LangfusePromptRecord = (TextPrompt | ChatPrompt) & {
    isFallback: boolean;
};
...
declare abstract class BasePromptClient {
    ...
    readonly prompt: string | ChatMessage[];
    readonly commitMessage: string | null | undefined;
    constructor(prompt: CreateLangfusePromptResponse, isFallback: boolean | undefined, type: "text" | "chat");
...
declare class TextPromptClient extends BasePromptClient {
    ...
    constructor(prompt: TextPrompt, isFallback?: boolean);
...
declare class ChatPromptClient extends BasePromptClient {
    ...
    constructor(prompt: ChatPrompt, isFallback?: boolean);
...
declare class LangfuseMedia {
     ...
     * ```
     */
    static resolveMediaReferences<T>(params: LangfuseMediaResolveMediaReferencesParams<T>): Promise<T>;
}
...
declare function configLangfuseSDK(params?: LangfuseCoreOptions, secretRequired?: boolean): LangfuseCoreOptions;
...
declare abstract class LangfuseCoreStateless {
    ...
    private debugMode;
    private pendingEventProcessingPromises;
    private pendingIngestionPromises;
    private release;
    protected sdkIntegration: string;
    private enabled;
    protected isLocalEventExportEnabled: boolean;
    private localEventExportMap;
    private projectId;
    private mask;
    private sampleRate;
    private environment;
    ...
    protected _getDatasetItems(query: GetLangfuseDatasetItemsQuery): Promise<GetLangfuseDatasetItemsResponse>;
    protected _fetchMedia(id: string): Promise<GetMediaResponse>;
    fetchTraces(query?: GetLangfuseTracesQuery): Promise<GetLangfuseTracesResponse>;
    fetchTrace(traceId: string): Promise<{
        data: GetLangfuseTraceResponse;
    }>;
    fetchObservations(query?: GetLangfuseObservationsQuery): Promise<GetLangfuseObservationsResponse>;
    fetchObservation(observationId: string): Promise<{
        data: GetLangfuseObservationResponse;
    }>;
    ...
    getDatasetRuns(datasetName: string, query?: GetLangfuseDatasetRunsQuery): Promise<GetLangfuseDatasetRunsResponse>;
    ...
    updatePromptStateless(body: UpdatePromptBody & {
        name: string;
        version: number;
    }): Promise<LangfusePromptClient>;
    getPromptStateless(name: string, version?: number, label?: string, maxRetries?: number, requestTimeout?: number): Promise<GetLangfusePromptResponse>;
    private _getBoundedMaxRetries;
    /***
     *** QUEUEING AND FLUSHING
     ***/
    protected enqueue(type: LangfuseObject, body: EventBody): void;
    protected processEnqueueEvent(type: LangfuseObject, body: EventBody): Promise<void>;
    private maskEventBodyInPlace;
    /**
    ...
    private getByteSize;
    protected processMediaInEvent(type: LangfuseObject, body: EventBody): Promise<void>;
    protected parseTraceId(type: LangfuseObject, body: EventBody): string | null | undefined;
    protected findAndProcessMedia({ data, traceId, observationId, field, }: {
        data: any;
        traceId: string;
        observationId?: string;
    ...
    protected constructAuthorizationHeader(publicKey: string, secretKey?: string): {
        Authorization: string;
    };
    private fetchWithRetry;
    private fetchAndLogErrors;
    shutdownAsync(): Promise<void>;
    _exportLocalEvents(projectId: string): Promise<SingleIngestionEvent[]>;
    shutdown(): void;
...
declare abstract class LangfuseCore extends LangfuseCoreStateless {
     ...
     * ```
     */
    resolveMediaReferences<T>(params: Omit<LangfuseMediaResolveMediaReferencesParams<T>, "langfuseClient">): Promise<T>;
...
export { type $defs, type ChatMessage, type ChatPrompt, ChatPromptClient, type CreateChatPromptBody, type CreateLangfuseDatasetBody, type CreateLangfuseDatasetItemBody, type CreateLangfuseDatasetItemResponse, type CreateLangfuseDatasetResponse, type CreateLangfuseDatasetRunItemBody, type CreateLangfuseDatasetRunItemResponse, type CreateLangfuseEventBody, type CreateLangfuseGenerationBody, type CreateLangfusePromptBody, type CreateLangfusePromptResponse, type CreateLangfuseScoreBody, type CreateLangfuseSpanBody, type CreateLangfuseTraceBody, type CreatePromptBody, type CreateTextPromptBody, type DatasetItem, type DatasetItemData, type DeferRuntime, type EventBody, type GetLangfuseDatasetItemsQuery, type GetLangfuseDatasetItemsResponse, type GetLangfuseDatasetParams, type GetLangfuseDatasetResponse, type GetLangfuseDatasetRunParams, type GetLangfuseDatasetRunResponse, type GetLangfuseDatasetRunsPath, type GetLangfuseDatasetRunsQuery, type GetLangfuseDatasetRunsResponse, type GetLangfuseObservationResponse, type GetLangfuseObservationsQuery, type GetLangfuseObservationsResponse, type GetLangfusePromptFailureData, type GetLangfusePromptResponse, type GetLangfusePromptSuccessData, type GetLangfuseSessionsQuery, type GetLangfuseSessionsResponse, type GetLangfuseTraceResponse, type GetLangfuseTracesQuery, type GetLangfuseTracesResponse, type GetMediaResponse, type GetMediaUploadUrlRequest, type GetMediaUploadUrlResponse, type IngestionBody, type IngestionReturnType, type JsonType, LangfuseCore, type LangfuseCoreOptions, LangfuseEventClient, type LangfuseEventProperties, type LangfuseFetchOptions, type LangfuseFetchResponse, LangfuseGenerationClient, LangfuseMedia, type LangfuseMediaResolveMediaReferencesParams, LangfuseMemoryStorage, type LangfuseMetadataProperties, type LangfuseObject, LangfuseObjectClient, LangfusePersistedProperty, type LangfusePromptClient, type LangfusePromptRecord, type LangfuseQueueItem, LangfuseSpanClient, LangfuseTraceClient, LangfuseWebStateless, type LinkDatasetItem, type MaskFunction, type MediaContentType, type ParsedMediaReference, type PatchMediaBody, type PromptInput, type SingleIngestionEvent, type TextPrompt, TextPromptClient, type UpdateLangfuseGenerationBody, type UpdateLangfuseSpanBody, type UpdatePromptBody, type Usage, type UsageDetails, type components, type operations, type paths, utils_d as utils, type webhooks };
