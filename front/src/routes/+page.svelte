<script lang="ts">
  ...
  const hacks = [
    ...
    },
    {
      ...
      url: img1,
      description:
        "Excessive delegation of authority leading to uncontrolled usage.",
    },
    {
    ...
    },
    {
      ...
      url: img3,
      description:
        "Enters business or legal commitments without proper supervision",
    },
    {
      label: "Hallucination",
      url: img4,
  ...
  <Dialog.Content>
    <div class="grid gap-8">
      <div class="grid gap-3">
        ...
        <p>
          Using your own prompt is a premium feature. You can use the default
          prompts or subscribe to our premium plan to unlock this feature.
        </p>
      </div>
...
<div class="h-full flex flex-col items-center">
  <div class="w-full max-w-4xl text-balance grid gap-4 text-center pt-16">
    ...
    <p class="text-3xl text-muted-foreground font-light">
      Learn and implement strategies to protect and educate against agent
      hacking.
    </p>
  ...
  <div class="flex flex-col gap-2 justify-center mt-12">
    <p class="text-muted-foreground text-center text-sm">
      Our bank of prompts (+10000 examples available in premium)
    </p>
  ...
  >
    <p class="text-xl font-semibold text-muted-foreground">
      Main vulnerabilities to protect against
    </p>
